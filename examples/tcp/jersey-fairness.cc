...
NS_LOG_COMPONENT_DEFINE ("JerseyFairness");
...
int main (int argc, char *argv[])
{
  ...
  std::string list[4] = {"TcpJersey","TcpWestwood","TcpVegas","TcpNewReno"};
  ...
  Config::SetDefault ("ns3::TcpL4Protocol::SocketType", TypeIdValue (TypeId::LookupByName ("ns3::"+list[i])));
   ...
   */
  PointToPointHybridDumbbellHelper d (nleftLeaf, nrightLeaf, left, right, middle, mobilityModel);
  ...
  std::cout << "Running the simulation for " << list[i] << std::endl;
